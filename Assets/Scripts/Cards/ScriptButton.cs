...
public class ScriptButton : MonoBehaviour
{
    ...
    {
        _buttonCard?.Invoke(GetComponent<Unit>().character.gameObject, gameObject); //el primero es la sprite de la carta (la morphologia) y el segundo es el boton que contiene esta script.
    }    
}
